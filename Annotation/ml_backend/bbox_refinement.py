...
def refine_bbox_with_mask(yolo_bbox: tuple, mask: np.ndarray, use_centroid: bool = False) -> tuple:
...
def refine_bboxes_batch(yolo_bboxes: np.ndarray, masks: np.ndarray, 
                        use_centroid: bool = False) -> np.ndarray:
