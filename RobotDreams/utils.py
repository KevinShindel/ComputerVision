...
images = [
    ...
    (
        "https://raw.githubusercontent.com/opencv/opencv/refs/heads/4.x/samples/data/chessboard.png",
        "images",
    ),
]
...
videos = [
    ...
    (
        "https://raw.githubusercontent.com/opencv/opencv/refs/heads/4.x/samples/data/vtest.avi",
        "videos",
    ),
]
...
def select_roi(frame) -> Sequence[float]:
    ...
    object_template = cv2.selectROI(
        win_name, overlay, showCrosshair=True, fromCenter=False
    )
